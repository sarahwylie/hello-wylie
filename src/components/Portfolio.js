...
function Portfolio() {
  ...
  //     return country.name.match(inputText);
  // });
  // }
  ...
  return (
    <section className="my-3 animate__animated animate__slideInUp" id="portfolio">
      ...
      <div className="flex-row justify-space-between">
        {/* <h4>Would you like to see examples of my work in a specific language, framework, or </h4>
        <input
            type="text"
            placeholder="Search"
            value={inputText}
        ...
        <Reveal effect="fadeInUp">
          <div className="col-12 mb-2 p-3 flex-column card">
            <div className='flex-row'>
              <div className='col-8'>
                <h3 className="portfolio-item-title"><a href="https://github.com/sarahwylie/TwitType"
                  alt="Back-end Framework for Twitter-Type site"
                  target="_blank"
                  rel="noopener noreferrer">TwitType</a></h3>
                <h5 className="portfolio-languages">
                  Built With:
                  Java, Spring Boot, Postman, PostgreSQL, Apache Maven
                </h5>
                <p>Back-end design for a Twitter-type social media site.</p>
                <BsGithub /><a href="https://github.com/sarahwylie/TwitType" className="btn mt-auto"><i className="mr-2"></i>View Project on GitHub</a>
              </div>
              <div className='col-4'>
                <img src={Schema} alt="Schema Design" className='snaps' />
              </div>
            </div>
          </div>
        </Reveal>
